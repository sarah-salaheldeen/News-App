    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                JSONArray authors = currentStory.getJSONArray("tags");
                String currentAuthor = authors.getJSONObject(0).get("webTitle").toString();

                News story = new News(storyTitle, section, currentAuthor, date, url);
